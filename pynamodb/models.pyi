...
class Model(metaclass=MetaModel):
    ...
    def delete(self, condition: Optional[Any] = ..., return_values: bool = ...) -> _T: ...
    def update(self, attributes: Optional[Dict[Text, Dict[Text, Any]]] = ..., actions: Optional[List[Any]] = ..., condition: Optional[Any] = ...) -> _T: ...
    def insert(self, condition: Optional[Any] = ...) -> _T: ...
    def refresh(self, consistent_read: bool = ...): ...
    def to_dict(self) -> Dict[str, Any]: ...
    @classmethod
    def get(cls: Type[_T], hash_key: KeyType, range_key: Optional[KeyType] = ..., consistent_read: bool = ..., attributes_to_get: Optional[Any] = ...) -> _T: ...
    @classmethod
    ...
    @classmethod
    def create_table(cls: Type[_T], wait: bool = ..., billing_mode: Text = ..., read_capacity_units: Optional[Any] = ..., write_capacity_units: Optional[Any] = ...): ...
    @classmethod
    def dumps(cls): ...
    @classmethod
